...
describe("idOwnershipBySignatureOnChainSmt", function () {
  this.timeout(600000);
  ...
  it("Ownership true. User state: genesis. Auth claims total/signedWith/revoked: 1/1/none", async () => {
    const inputs = {
      ...
      "userNullifier": "3886931623570934357017887171328389254245198238824798786420210009480671968146",
  ...
  it("Ownership true. User state: not-genesis. Auth claims total/signedWith/revoked: 2/2/none", async () => {
    const inputs = {
      ...
      "userNullifier": "1958873713344339126643835800912906153736137480363386060715177511808049651739",
