...
describe("buildClaimAuthKSignBBJJ test", function () {
    ...
    it("Test BuildClaimAuthKSignBBJJ", async () => {
        ...
        let input = "20634138280259599560273310290025659992320584624461316485434108770067472477956";
        // let input = "2006343756953729302788634646776432144113870616756499754430019488750560779821"; // SwapEndianness
