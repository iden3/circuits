...
describe("buildClaimAuthKSignBBJJ test", function () {
    ...
    it("Test BuildClaimAuthKSignBBJJ", async () => {
        ...
        let input = "2006343756953729302788634646776432144113870616756499754430019488750560779821";
        ...
        console.log(rHi.toString(16));
        console.log(rHv.toString(16));
        console.log("rHi string", rHi.toString());

        assert.equal(rHi.toString(), "17611975394326802955172662837194865111253549123001923344930051470191931257028", "not equal");
