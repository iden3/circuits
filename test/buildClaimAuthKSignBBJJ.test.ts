...
describe("poseidon test", function () {
    ...
    it("Test poseidon compatibility with go-iden3-crypto/poseidon", async () => {
        ...
        witness = circuit.calculateWitness({
            in: ["72057594037927936", "1", "20634138280259599560273310290025659992320584624461316485434108770067472477956"]
        });
        assert(circuit.checkWitness(witness));
        out = witness[circuit.getSignalIdx("main.out")];
...
describe("buildClaimAuthKSignBBJJ test", function () {
    ...
    it("Test BuildClaimAuthKSignBBJJ", async () => {
        ...
        const input = "20634138280259599560273310290025659992320584624461316485434108770067472477956";
        // const input = "2006343756953729302788634646776432144113870616756499754430019488750560779821"; // SwapEndianness
        ...
        assert.equal(rHi.toString(), "10395143007367284783361235630029585391855532481545192724789751124286001219030", "not equal");
