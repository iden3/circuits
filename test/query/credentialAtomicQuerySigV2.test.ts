...
describe("Test CredentialAtomicQuerySig.circom V2", function() {
    ...
    before(async () => {
        circuit = await wasm_tester(
            path.join(__dirname, "../circuits/query", "credentialAtomicQuerySigTestV2.circom"),
            {
    ...
    it("credentialAtomicQuerySigTest V2", async () => {
        ...
        const expOut = {
            valueHash: "12318170313255245672316474728989853559285836715177437428940010106215877366017",
            userState: "18656147546666944484453899241916469544090258810192803949522794490493271005313",
            issuerID: "26599707002460144379092755370384635496563807452878989192352627271768342528",
