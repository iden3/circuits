...
describe("Test verifyExpirationTime",  function() {
    ...
    it("#success claim with expiration time", async () => {
        ...
        testData.in = {expirationFlag: "1", claim: claim, timestamp: 1669884009};
        testData.expOut = {};
    });
    ...
    it("#success expiration flag 0", async () => {
        ...
        testData.in = {expirationFlag: "0", claim: claim, timestamp: 1669884009};
        testData.expOut = {};
    });
    ...
    it("#success expiration flag 1, timestamp equal to expiration", async () => {
        ...
        testData.in = {expirationFlag: "1", claim: claim, timestamp: 1669800008};
        testData.expOut = {};
    });
