...
describe("idUtils.circom:", async function() {
    ...
    const tests = [
        {
            ...
            output: {
                out: "376456579615209717367026420083895536778545545416798606485883050226426692080",
            },
        },
    ];
    ...
    before(async () => {
        circuit = await wasm_tester(
            path.join(__dirname, "../circuits", "idUtils_NewID.circom"),
            {
                output: path.join(__dirname, "../circuits", "build/idUtils_NewID"),
                recompile: true,
